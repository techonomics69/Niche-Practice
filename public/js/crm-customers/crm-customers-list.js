...
$(document).ready( function () {
    ...
    $(document).on('click',"#showCustomizeEmailModal",function (e){
        ...
        if(checkDefault=='false'){
            ...
            $('#email-preview-wrap .content-body').html('<textarea id="customizedEmailMessage" maxlength="160"  class="form-control" data-placeholder="Enter Text Here..."></textarea>\n' +
    ...
    $(document).on('click',"#showCustomizeSMSModal",function (e){
        ...
        if(checkDefault=='false'){
            ...
            $('#sms-preview-wrap .content-body').html('<textarea id="customizedSMSMessage" maxlength="160" class="form-control" data-placeholder="Enter Text Here..."></textarea>\n' +
                '<div class="edit-icons">\n' +

...
// if ( $(".customize-editor1").length > 0 )
// {
//     taskEditor = $('.customize-editor1');
// }
// else if($(".customize-editor1").length > 0)
// {
//     taskEditor = $('#sample-description');
// }
// else
// {
    taskEditor = $('#sample_description');
// }
...
jQuery(document).ready(function($) {
    ...
    taskEditor.summernote({
        ...
        callbacks: {
            onImageUpload: function(files, editor, welEditable) {
                ...
                // sendFile();
                // files[0], editor, welEditable
                // console.log("file");
                // console.log(files[0]);
                var data = new FormData();
                data.append("send", 'save-images');
                ...
                $.ajax({
                    ...
                    if(url !== '')
                    {
                        ...
                        var image = $('<img>').attr('src', 'http://'+baseUrl+'/storage/app/public/' + url);
                        // var image = $('<img>').attr('src', '/storage/app/public/' + url);

                        // console.log("image");
                        // console.log(image);
                        taskEditor.summernote("insertNode", image[0]);
                    }
    ...
    $('body').on('click','.selectVariable',function() {
        ...
        if (rel == "body") {
            ...
            var context_textarea = window.document.getElementById('sample_description');
...
$(function () {
    // $('#credits_description').summernote({
    //     height: 200
    // });
});

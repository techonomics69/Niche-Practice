        ...
        <div class="container dashboarbgtitle upgrade-plan-container">
            <div class="">
                <div class="page-head" style="margin-top: 40px;">
                    <div class="row">
                        <div class="col-md-12">
                            <h4 class="page-title text-center">Stock Up On Credits
...
{{--                                </a>--}}
                            ...
                            <p class="page-subheading text-center stock-up-des" style="padding-top: 8px;" >The more you buy the better the rate.  Use them as you go when you need the little extra help!
                            </p>
...
{{--                        <p class="faq-p-credit">The credits you purchase are immediately added to your account. When you request a Marketing Pro service to--}}
{{--                            complete a specific task, the number of credits for that service is deducted from your account. The number of credits it costs to complete a task vary depending on the complexity and time required to complete the task.</p>--}}

                        ...
                        <div class="input-field">
                            <div class="col-sm-6">
                                ...
                                <div class="m-t-20 col-sm-12 no-padding">
                                    ...
                                    <textarea id="content" name="content"  class="form-control" rows="5">{{ $category['content'] }}</textarea>
                                </div>

{{--                                <div class="m-t-20 col-sm-3 no-padding">--}}
{{--                                    <label>Credits</label>--}}
{{--                                    <input type="number" id="credits" name="credits" value="{{ $category['credits'] }}" class="form-control">--}}
{{--                                </div>--}}
...
{{--                                                <option value="{{ $i }}">{{ $i }}</option>--}}
                                                <option value="{{ $i }}" {{ selectedChosenValue($category['priority'], $i) }}>{{ $i }}</option>
                                            @endfor
                                        </select>
                                    </div>
                                </div>
...
{{--                                            <option value="non-marketing-campaign" {{ selectedChosenValue($category['type'], 'non-marketing-campaign') }}>Non-Marketing Campaign</option>--}}
{{--                                            <option value="marketing-campaign" {{ selectedChosenValue($category['type'], 'marketing-campaign') }}>Marketing Campaign</option>--}}
{{--                                            <option value="" {{ (empty($category['type'])) ? 'selected': '' }}>Default</option>--}}
{{--                                        </select>--}}
{{--                                        <div style="margin-top: 5px;">--}}
{{--                                            <input type="checkbox" id="show-to-paid-mark" style="/* padding-top: 8px; *//* float: left; *//* padding-right: 12px; */" {{ (!empty($category['show_to_paid'])) ? 'checked': '' }}>--}}
{{--                                            Show this category to Paid User</div>--}}
{{--                                    </div>--}}
{{--                                    <div class="m-t-20">--}}
{{--                                        <label>Priority</label>--}}
{{--                                        <select class="form-control selectpicker" id="category-priority" name="priority">--}}
{{--                                            <option value=""></option>--}}
{{--                                            @for($i=1; $i<=10;$i++)--}}
{{--                                                <option value="{{ $i }}" {{ selectedChosenValue($category['priority'], $i) }}>{{ $i }}</option>--}}
{{--                                            @endfor--}}
...
{{--                                    <textarea id="{{$description}}" name="{{$description}}" class="form-control ckeditor customize-editor">{{ $category[$description]  }}</textarea>--}}
...
{{--                                        <option value=""></option>--}}
{{--                                        <option value="full-width-cover" {{ selectedChosenValue($category['settings_module'], 'full-width-cover') }}>Full Width Cover</option>--}}
{{--                                    </select>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                            ...
                            <div class="col-sm-12">
                                <div class="action-btn">
                                    ...
                                    <button class="btn btn-primary save-name save-action" data-customer-id="{{ $category['id'] }}">Update</button>
                                </div>
    ...
    <script>
        ...
        $(document.body).on('click', '.save-name' ,function() {
            ...
            if(contactId !== ''){
                ...
                if(logo.length > 0) {
                    // console.log("logo in");marketing-pro/

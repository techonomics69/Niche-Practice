                    ...
                    <div class="col-sm-12 input-form">
                        ...
                        <div class="input-field">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-12 no-padding plan-block">
                                    {{--                                        <div class="m-t-20">--}}
                                    {{--                                            <label>Type</label>--}}
                                        ...
                                        <select class="form-control selectpicker" id="association" name="association"
                                            ...
                                            @if(!empty($association))
                                                ...
                                                @foreach($association as $record)
                                                    ...
                                                    ?>
                                                    <option value="{{$record['id']}}">{{$association}}</option>
                                                    <?php
                                                    //                                                        $industryKey++;
                                                    ?>
                                                @endforeach
                                    ...
                                    <div class="m-t-20">
                                        ...
                                        <select class="form-control selectpicker" id="library-type" name="library_type">
                                            ...
                                            {{--                                                <option value="1">DO-IT-WITH-ME</option>--}}
                                            {{--                                                <option value="2">DO-IT-FOR-ME</option>--}}
                                            {{--                                                <option value="1">Marketing Packages</option>--}}
                                            <option value="2">Individual Campaigns</option>
                                ...
                                <div class="col-sm-12 no-padding">
                                    <div class="m-t-20">
                                        ...
                                        <div style="margin-top: 5px; display: flex;">
                                            <input type="checkbox" id="show-to-paid"
                                                   style="margin-right: 3px;/* padding-top: 8px; *//* float: left; *//* padding-right: 12px; */">
                                    ...
                                    <div class="m-t-20">
                                        ...
                                        <select class="form-control selectpicker" id="campaign_filter"
                                        ...
                                        <select class="form-control selectpicker" id="industry" name="industry">
                                            ...
                                            @if(!empty($records))
                                                ...
                                                @foreach($records as $record)
                                                    ...
                                                    ?>
                                                    <option value="{{$record['id']}}">{{$industry}}</option>
                                                    <?php
                                                    //                                                        $industryKey++;
                                                    ?>
                                                @endforeach
                                    ...
                                    <div class="m-t-20">
                                        <label>Niche</label>
                                        <select class="form-control select2" id="niche" name="niche"></select>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="m-t-20 form-group {{ $errors->has($description) ? ' has-error' : '' }}">
                                    ...
                                    <textarea id="sampleDescription" name="{{$sampleDescription}}"
                                              class="form-control summernote">{{ old($sampleDescription) }}</textarea>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(function () {
            $(".save-action").click(function () {
                ...
                // var association = [];
                // var i = 0;
                // for( i; i < associated.length; i++ ){
                //     association[i] = associated[i];
                // }
                ...
                $.ajax({
                    ...
                    if (statusCode == 200) {
                        ...
                        showPreloader();
                        window.location.href = baseUrl + '/admin/task/category/' + id + '/edit';

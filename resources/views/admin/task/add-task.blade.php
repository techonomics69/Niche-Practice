                    ...
                    <div class="box-body row">
                        ...
                        <div class="form-group col-md-12 {{ $errors->has('categories') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3 {{ $errors->has($estimatedTime) ? ' has-error' : '' }}">
                                ...
                                <input type="text" id="estimated-time" name="estimated_time" value="{{ old($estimatedTime) }}" class="form-control" />
...
//                                    ];
                                    ...
                                    ?>
                                    <option value="{{ $weekRow['id'] }}" {{ selectedChosenValue(old('week'), $weekRow['id']) }}>{{ $weekRow['name'] }}</option>
                                    <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="form-group col-md-12">
                            <div class="col-md-4 nopadding">
                                ...
                                <select class="form-control selectpicker" id="recurring" name="recurring_days">
                                    ...
                                    ?>
                                    <option value="{{ $index }}" {{ selectedChosenValue(old('recurring_days'), $index) }}>{{ $recurringRow }}</option>
                                    <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="form-group col-md-12">
                            <div class="col-md-4 nopadding">
                                <label>Credits</label>
                                <input type="number" id="{{ $credits }}" name="{{ $credits }}" value="{{ old($credits) }}" class="form-control" />
                        ...
                        <div class="form-group col-md-12 {{ $errors->has($creditsDescription) ? ' has-error' : '' }}">
                            ...
                            <textarea id="{{$creditsDescription}}" name="{{$creditsDescription}}" class="form-control customize-editor">{{ old($description) }}</textarea>

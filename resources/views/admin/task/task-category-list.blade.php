        ...
        <div class="col-sm-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title m-t-10">Category List</h3>

                    <div id="datatable_button_stack" class="pull-right text-right">
                        <a href="{{ route('admin.add-category') }}" class="btn btn-primary ladda-button" data-style="zoom-in">
                            <span class="ladda-label"><i class="fa fa-plus"></i> Add Category</span>
                        </a>
                    </div>
                </div>
                <div class="box-body">
                                ...
                                <tr>
                                    ...
                                    <td class="inddustry-name name-panel">
                                        <span class="name">
                                            @if(!empty($row['parent']))
                                            {{ $row['name'] }}
{{--                                                <strong>{{ '(Copy reference ' . $row['parent'] . ' )' }}</strong>--}}
                                            @else
                                                {{ $row['name'] }}
                                            @endif
                                        </span>
                                    ...
                                    @php
                                        $planType = $row['library_type'];
                                        $plan = '';
                                        if(!empty($planType) && $planType == 1)
                                            /*$plan = 'Niche';*/
                                            $plan = 'Do-It-With-Me';
                                        elseif(!empty($planType) && $planType == 2)
                                            /*$plan = 'Premium';*/
                                            $plan = 'Do-It-For-Me';
                                        else
                                            $plan = '';
                                    ...
                                    <td>
                                        @if( checkValue($row['niche']) && $row['niche'] == 0 )
                                            <p>All Niches</p>
                                        @else
                                            {{ @$row['niches'][0]['niche'] }}
                                        @endif
...
{{--                                    </td>--}}
{{--                                    <td>{{$row['niche']}}--}}
{{--                                        <option value="0" {{selectedChosenValue($category['niche'],0)}}>All Niches</option>--}}
{{--                                    </td>--}}
{{--                                    <td>--}}
{{--                                        @if(!empty($records))--}}
                                            <?php
...
//                                                    $industry = $record['name'];
                                                    ?>
{{--                                                    <p {{selectedChosenValue($record['id'],$row['industry'])}}>{{$industry}}</p>--}}
                                                    <?php
                                                    //                                                            $industryKey++;
                                                    ?>
{{--                                                @endif--}}
...
//                                        $data['12-month-campaign'] = '12-month-campaign';
...
{{--                                            <a href="javascript:void(0)" class="btn btn-sm btn-link " style="font-size: 12px;padding: 3px 0px;" data-target-id=""><i class="fa fa-copy"></i> Copy</a>--}}
                                            <a href="{{ route('task.edit.category', $row['id']) }}" class="btn btn-sm btn-link edit-me1" style="font-size: 12px;padding: 3px 0px;" data-target-id="{{ $row['id'] }}"><i class="fa fa-edit"></i> Edit</a>
...
@section('js')
    ...
    <script>
        ...
        $('.copy-me').click(function () {
            var siteUrl = $('#hfBaseUrl').val();
            var category = $(this).attr('data-target-id');
            var currentTarget = $(this);
